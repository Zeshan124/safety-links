...
const values = [
  { icon: Shield,          title: "Security First",    desc: "Every solution we deliver is designed to provide maximum protection for your property." },
  ...
  { icon: Clock,           title: "On-Time Delivery",  desc: "We respect your timeline and consistently deliver projects on schedule." },
];
  ...
  return (
    <>
      <style>{`
        ...
        /* Mini stat chips in story section */
        .ab-mini-stat {
          background: #fff;
        ...
        .ab-value-card:hover { border-color: rgba(39,155,81,0.28); transform: translateY(-3px); box-shadow: 0 10px 30px rgba(18,58,101,0.1); }
        ...
        .ab-value-card:hover .ab-value-icon { background: rgba(39,155,81,0.12); border-color: rgba(39,155,81,0.5); }
        ...
        .ab-team-card:hover { border-color: rgba(39,155,81,0.28); transform: translateY(-3px); box-shadow: 0 10px 30px rgba(18,58,101,0.1); }
        .ab-team-card:hover::after { transform: scaleX(1); }
        .ab-avatar {
          width: 64px; height: 64px;
          border-radius: 50%;
          background: rgba(39,155,81,0.1);
          border: 2px solid rgba(39,155,81,0.3);
          display: flex;
          align-items: center;
          justify-content: center;
        ...
        .ab-team-card:hover .ab-avatar { background: rgba(39,155,81,0.18); border-color: rgba(39,155,81,0.6); }
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-center mb-20">
              ...
              <div>
                ...
                <h2
                  className="ab-serif"
                  style={{ fontSize: "clamp(26px, 4vw, 40px)", fontWeight: 700, color: "#0f2d4a", lineHeight: 1.1, marginBottom: 20 }}
                >
                ...
                <p style={{ fontSize: 14, color: "#6b7280", lineHeight: 1.8, marginBottom: 14 }}>
                  We specialize in the full lifecycle — from initial site surveys and custom design through installation, testing, and long-term maintenance. Our team of certified engineers handles everything in-house, ensuring consistent quality on every project.
                </p>
              ...
              <div className="relative">
                <div style={{ borderRadius: 3, overflow: "hidden", boxShadow: "0 20px 60px rgba(10,22,40,0.18)" }}>
                  <img
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: 11, color: "rgba(240,236,228,0.55)", letterSpacing: "0.5px", marginTop: 3 }}>
                    Years of Excellence
                  </div>
                </div>
                {/* Left accent line */}
            ...
            <div className="mb-20">
              <div className="text-center mb-10">
                <div className="ab-eyebrow">Meet the Team</div>
                <h2
                  className="ab-serif"
                  style={{ fontSize: "clamp(24px, 4vw, 36px)", fontWeight: 700, color: "#0f2d4a", lineHeight: 1.1 }}
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                {team.map((member) => (
                  <div key={member.name} className="ab-team-card">
                    ...
                    <h3
                      className="ab-serif"
                      style={{ fontSize: 18, fontWeight: 600, color: "#0f2d4a", marginBottom: 3, lineHeight: 1.2 }}
                    >
                      {member.name}
                    </h3>
                    <div style={{ fontSize: 10.5, color: "#279B51", fontWeight: 500, letterSpacing: "0.5px", textTransform: "uppercase", marginBottom: 10 }}>
                      {member.role}
                    </div>
